      ...
      <div className="max-w-3xl mx-auto px-8">
        ...
        <motion.div {...fadeUp} className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 justify-items-center">
          <a
            ...
            className="group flex flex-col items-center text-center p-8 border border-border hover:border-primary transition-colors w-full max-w-[800px]"
          >
          ...
          <div className="flex flex-col items-center text-center p-8 border border-border w-full max-w-[800px]">
