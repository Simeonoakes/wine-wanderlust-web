    ...
    <footer className="border-t border-border py-16">
      <div className="max-w-7xl mx-auto px-8 grid grid-cols-12 gap-8">
        <div className="col-span-12 md:col-span-4">
          ...
          <span className="font-signature text-5xl tracking-tight text-primary leading-none"><span className="font-display text-[0.85em] align-baseline">I</span>n <span className="font-display text-[0.85em] align-baseline">V</span>ino <span className="font-display text-[0.85em] align-baseline">V</span>eritas</span>
