  ...
  <div className="min-h-screen">
    ...
    <div className="max-w-4xl mx-auto px-8 py-20">
      ...
      <motion.div {...fadeUp} className="mt-10 space-y-6 text-sm text-muted-foreground leading-relaxed font-body">
        ...
        <p>
          The medieval village of <span className="text-foreground font-medium">Lagrasse</span>, officially one of the most beautiful villages in France, straddles the Orbieu river with its stone bridges, cobbled streets, and the magnificent Benedictine abbey that has stood watch since the 8th century.
        </p>
        <p>
          Beyond these landmarks, the landscape itself is the attraction — rolling hills covered in low scrubby garrigue giving way to dramatic gorges and hidden valleys. Rocky outcrops catch the golden light of sunset, turning the entire terrain into a canvas of amber, ochre, and deep green. It is a place where you can walk for hours and encounter nothing but the sound of the wind through the pines and the distant call of a buzzard.
        </p>
        <p>
